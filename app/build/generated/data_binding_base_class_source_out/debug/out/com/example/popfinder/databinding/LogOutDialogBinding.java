...
public final class LogOutDialogBinding implements ViewBinding {
  ...
  private LogOutDialogBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static LogOutDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.log_out_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static LogOutDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LogOutDialogBinding((ConstraintLayout) rootView, textView);
    }
